...
describe("Testes para o middleware validateBasicAuth", () => {
  ...
  test(`Deve retornar a mensagem 'Usuário não autorizado' e statusCode
  'Unauthorized' se o cabeçalho de autorização estiver preenchido com
  credenciais que não sejam do Santa Claus`, () => {
    const req = { headers: {
  ...
  test(`Deve chamar a função 'next' se o cabeçalho for preenchido com as
  credenciais corretas do Santa Claus`, () => {
    const req = { headers: {
