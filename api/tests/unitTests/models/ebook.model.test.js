...
describe('Testes para EbookModel', () => {
  ...
  describe('findEbookByTitle', () => {
    test(`Deve fazer a busca por um ebook pelo título e retornar os
    dataValues caso ele exista no banco de dados`, async () => {
    ...
    test(`Deve fazer a busca por um ebook pelo título e retornar 'null' caso
    ele não exista no banco de dados`, async () => {
  ...
  describe('createEbook', () => {
    test('Deve criar um novo ebook e retornar os valores corretos',
    async () => {
      const { title, author, genre } = validFieldsEbook;
  ...
  describe('findAllEbooks', () => {
    test(`Deve retornar uma lista com todos os ebooks cadastrados no banco
    de dados`, async () => {
